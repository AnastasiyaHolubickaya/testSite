            ...
            <div className={classes.block}>
                <div className={classes.item_text}>
                    ...
                    <span className={classes.info}>
                        <NavLink to=''> SparkleAppz</NavLink>, an app development Indian company in Jodhpur,
                        ...
                        <NavLink className={classes.noBold} to =''>company</NavLink>  to deploy faster
                    ...
                    <NavLink to="/portfolio"><button className={classes.btn}>check out portfolio <b> &#8594;</b></button></NavLink>
